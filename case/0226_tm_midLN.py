...
def calculate_entropy(attn, mask):
    ...
    entropy = -masked_attn * torch.log(masked_attn)
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, q, k, v, attn_mask=None):
        ...
        return self.layer_norm(output) + q , entropy
...
class FeedForward(nn.Module):
    ...
    def forward(self, x):
        ...
        output = self.layer2(self.dropout1(F.relu(self.layer1(x)))) #dropout 2번 적용으로 수정
