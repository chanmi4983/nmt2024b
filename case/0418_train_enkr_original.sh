...
MODEL_FILE=$LANG1'2'$LANG2'MidLNdkPara0416.gpu'$1'.demo'
# 모델이름 바꾸기
...
CUDA_VISIBLE_DEVICES=$1,CUDA_LAUNCH_BLOCKING=1 python3 -W ignore nmt_train.py \
        ...
        --log_interval=10 --valid_start=500000 --valid_interval=50000 \
        --resume=$RESUME --resume_line=$RESUME_LINE --resume_file=$RESUME_FILE --lr=$LR \
        --logging=1
        #--log_interval=5000 --valid_start=500000 --valid_interval=5000 \
 #5000, 500000, 50000
# kr2en (in valid)
