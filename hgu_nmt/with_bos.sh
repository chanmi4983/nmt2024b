...
TRANS_FILE='./trans/'$MODEL_PREFIX'.with_bos_Hael' # 출력 파일
...
# BOS를 포함한 어텐션 맵 생성 (--save_attention 옵션만 추가)
...
echo "BOS를 포함한 어텐션 맵이 ./trans/attention_maps_with_bos_Hael/ 디렉토리에 저장되었습니다."