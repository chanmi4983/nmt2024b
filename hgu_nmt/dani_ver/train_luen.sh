...
MODEL_FILE=$LANG1'2'$LANG2'.l'$N_LAYERS'.d'$DIM_MODEL'.ff'$DIM_FF'.gpu'$1'.qv'
RESUME=0
OPT_SCHEDULED=0
...
RESUME_FILE='lu2en.l6.d512.ff2048.raw.gpu1s2.voc.pth' # NMT-68
...
CUDA_VISIBLE_DEVICES=0,CUDA_LAUNCH_BLOCKING=1 python3.8 -W ignore nmt_run.py \
        ...
        --print_every=1000 --valid_start=20000 --valid_every=5000 \
