...
parser.add_argument("input", type=argparse.FileType('r'), nargs="+",
                    help="The source input files")
#parser.add_argument("trg_input", type=argparse.FileType('r'), nargs="+",
#                    help="The target input files")
...
parser.add_argument("-n", "--ngram", type=int, metavar="N",
                    help="create n-grams")
parser.add_argument("-j", "--joined", type=int, metavar="N",
                    help="make joined vocabularly for both languages")
