...
def read_dict(dic_file, const_id=None):
    ...
    if const_id is None:
        ...
        src_dict2['</s>'] = const_id.EOS
        src_dict2['<unk>'] = const_id.UNK
    return src_dict2
...
class TextPairIterator:
    ...
    def __next__(self):
        ...
        x_data, x_mask, y_data, y_mask, y_lens = self.prepare_text_pair(source, target)
        self.iters = self.iters + 1
        return x_data, x_mask, y_data, y_mask, y_lens, self.cur_line_num, self.iters
    ...
    def prepare_text_pair(self, seqs_x, seqs_y):
        ...
        return x_data, x_mask, y_data, y_mask, lengths_y
