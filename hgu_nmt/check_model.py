...
if 1:
    if 'encoder.pos_enc.scale' not in param.keys():
        print('pos scale is not trainable')
        exit()

    enc_scale = param['encoder.pos_enc.scale']
    dec_scale = param['decoder.pos_enc.scale']

    print('POS Scale', enc_scale, dec_scale)
